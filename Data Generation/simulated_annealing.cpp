...
vector<string> recipe = {"rw", "rs -K 12", "rs -K 12", "rfz", "fsto", "rwz", "fsto", "rs -K 8 -N 2", "rs -K 12 -N 2", "rs -K 12 -N 2", "rs -K 14", "rwz", "rs -K 16", "rfz", "rs -K 12 -N 2", "b", "fsto", "rf", "rwz", "rf", "rs -K 16", "rs -K 8", "rs -K 8"
};
...
int main() {
    ...
    ofstream output_file("abc_stats_tv80_qor2.csv",ios:: app);
