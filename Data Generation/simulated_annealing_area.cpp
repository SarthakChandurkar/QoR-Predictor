...
vector<string> recipe = {"b", "rfz", "rs -K 6", "rwz", "rf", "rfz", "fsto", "b", "rw", "rf", "rf", "rfz", "rs -K 6 -N 2", "rs -K 8", "fsto", "b", "rw", "rwz", "rf", "rfz", "rs -K 8 -N 2", "rwz", "fsto"
};
...
int main() {
    ...
    ofstream output_file("abc_stats_anealArea_Best.csv",ios:: app);
